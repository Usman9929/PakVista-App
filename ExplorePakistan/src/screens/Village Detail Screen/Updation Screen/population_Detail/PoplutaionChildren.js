    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.formContainer}>
                <Text style={styles.header}>Population Children</Text>

                <Text style={styles.label}>Total Children Population:</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Enter total number of children in the area"
                ...
                <TextInput
                    style={styles.input}
                    placeholder="Enter the age range (e.g., 0-14 years)"
                    placeholderTextColor="#888"
                    value={ageRange}
                ...
                <TextInput
                    style={styles.input}
                    placeholder="Enter the percentage of children in the population"
                    placeholderTextColor="#888"
