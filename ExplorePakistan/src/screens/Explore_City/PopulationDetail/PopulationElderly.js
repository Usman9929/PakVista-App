...
import styles from '../../Village Detail Screen/Updation Screen/Community_Services_Screen/Community_Services_Screen_style';

const PopulationElderly = () => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.formContainer}>
                <Text style={styles.header}>Population Elderly</Text>

                <Text style={styles.label}>Total Elderly Population:</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Enter total number of elderly in the area"
                ...
                <TextInput
                    style={styles.input}
                    placeholder="Enter the percentage of elderly in the population"
                    placeholderTextColor="#888"
...
export default PopulationElderly;
